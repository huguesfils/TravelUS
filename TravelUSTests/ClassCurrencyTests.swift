...
class ClassCurrencyTests: XCTestCase {
    func testGetCurrencyShouldPostFailedCallback() {
        ...
        let currencyService = CurrencyService(
            currencySession: URLSessionFake(data: nil, response: nil, error: FakeCurrencyResponseData.error))
    ...
    func testGetCurrencyShouldPostFailedCallbackIfNoResponse() {
        // Given
        let currencyService = CurrencyService(
            currencySession: URLSessionFake(data: FakeCurrencyResponseData.currencyCorrectData, response: nil, error: nil))
    ...
    func testGetCurrencyShouldPostFailedCallbackIfNoData() {
        // Given
        let currencyService = CurrencyService(
            currencySession: URLSessionFake(data: nil, response: FakeCurrencyResponseData.responseOK, error: nil))
